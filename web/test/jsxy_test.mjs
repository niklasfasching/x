...
import {html, render, route, useState, useAsync, useEffect} from "../src/jsxy.mjs";
  ...
  t.describe("foo", () => {
    ...
    t.only("route", async () => {
      function Component({$, ...props}) {
        return html`<div>
          <ul>
            <li><a href="?/view/10">view 10</a></li>
            <li><a href="?/edit/10">edit 10</a></li>
            <li><a href="?/">main</a></li>
            <li><a href="#foobar">set hash</a></li>
          </ul>
    ...
    t("static render", async () => {
      const Component = function({$}) {
        const r = useAsync(() => new Promise(r => setTimeout(() => r(42), 500)));
        useEffect(() => console.log("effect", $.x));
        if (r.loading) return html`<x-component $x>loading</>`
        return html`<x-component $x>${r.value}</>`
      };

      render(html`<${Component} v=${html`<span $bar/>`} id=main/>`, document.body);
